(function($) {
  ...
  var emailCapture = firebase.database().ref('emails/strawberriesFive');
  var locationRecord = firebase.database().ref('location/strawberriesFive');
...
// _____________________________________________________________________________
  ...
  window.onload = function() {
    firebase.database().ref('location/strawberriesFive/val').once('value').then(function(snapshot) {
